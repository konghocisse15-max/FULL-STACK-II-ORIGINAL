import { b as buildDayTableRenderRange, T as TableDateProfileGenerator } from './e9fdd609.js';
import { jsx, jsxs } from 'react/jsx-runtime';
import { createRef, createElement } from 'react';
import { j as joinClassNames, f as fracToCssDim } from './4d8981c2.js';
import { D as DateComponent, e as afterSize, b as buildNavLinkAttrs, w as watchHeight, N as NowTimer, V as ViewContainer, d as Scroller } from './65e66012.js';
import { joinDateTimeFormatParts, formatIsoMonthStr, createDuration, intersectRanges } from '@full-ui/headless-calendar';
import { m as memoize, s as setRef, a as generateClassName, g as getIsHeightAuto } from './0bcf2ebd.js';
import { k as computeViewBorderless, c as createFormatter } from './0219b752.js';
import { c as classNames } from './f00a2212.js';
import { b as buildDayTableModel, c as createDayHeaderFormatter, d as buildDateRowConfig, R as RefMap, D as DayTableSlicer, e as Ruler, f as DayGridHeaderRow, g as DayGridRows, h as dayMicroWidth } from './fa08d070.js';
    ...
    render() {
        ...
        return (jsx("div", { role: 'listitem', style: { width: props.width }, children: jsxs("div", { role: 'grid', "aria-labelledby": this.titleId, "data-date": props.isoDateStr, className: joinClassNames(generateClassName(options.singleMonthClass, {
                    ...
                    multiMonthColumns: props.colCount || 0,
                        ...
                        }, children: jsx("div", { ...navLinkAttrs, className: joinClassNames(generateClassName(options.singleMonthHeaderInnerClass, headerRenderProps), navLinkAttrs.className), children: joinDateTimeFormatParts(dateEnv.formatToParts(monthStartDate, props.titleFormat)) }) }), jsxs("div", { className: joinClassNames(generateClassName(options.tableClass, {
                            borderlessX,
                            borderlessTop,
                            borderlessBottom,
                            multiMonthColumns: props.colCount || 0,
                        ...
                        }, children: [jsxs("div", { ref: this.tableHeaderElRef, className: joinClassNames(generateClassName(options.tableHeaderClass, {
                                    isSticky: isTitleAndHeaderSticky,
                                    borderlessX,
                                    borderlessTop,
                                    borderlessBottom,
