import { m as mapHash, n as createEmptyEventStore, af as combineEventUis, ag as hasBgRendering, a5 as getEventKey, c as createFormatter, a4 as sortEventSegs, a6 as getEventRangeMeta, ah as buildEventRangeKey, u as isPropsEqualShallow, k as computeViewBorderless, j as isArraysEqual } from './0219b752.js';
import { m as memoize, B as BaseComponent, C as ContentContainer, a as generateClassName, s as setRef, V as ViewContextType, r as renderText, g as getIsHeightAuto, d as getTableHeaderSticky, e as getFooterScrollbarSticky, f as getScrollerSyncerClass } from './0bcf2ebd.js';
import { intersectRanges, createDuration, asRoughMs, wholeDivideDurations, formatIsoTimeString, addDurations, addDays, startOfDay, formatDayString, multiplyDuration, joinDateTimeFormatParts, diffDays, rangeContainsMarker } from '@full-ui/headless-calendar';
import { S as Slicer, k as DayGridRow, l as computeColFromPosition, m as getCellEl, n as DaySeriesModel, o as DayTableModel, p as SegHierarchy, q as groupIntersectingSegs, r as binarySearch, s as getCoordRangeEnd, M as MoreLinkContainer, B as BgEvent, t as renderFill, R as RefMap, i as computeColWidth, f as DayGridHeaderRow, e as Ruler, h as dayMicroWidth } from './fa08d070.js';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { h as watchWidth, D as DateComponent, S as StandardEvent, g as getDateMeta, j as watchSize, c as buildDateStr, b as buildNavLinkAttrs, e as afterSize, d as Scroller, V as ViewContainer } from './65e66012.js';
import { j as joinClassNames, f as fracToCssDim } from './4d8981c2.js';
import { createRef, createElement } from 'react';
import { c as classNames } from './f00a2212.js';
import { F as FooterScrollbar } from './fdec274f.js';
    ...
    render() {
        ...
        return (jsxs(Fragment, { children: [options.dayHeaders && (jsxs("div", { className: joinClassNames(generateClassName(options.tableHeaderClass, {
                    ...
                    classNames.flexCol, tableHeaderSticky && classNames.tableHeaderSticky), style: {
                        ...
                        zIndex: 0,
                    }, children: [options.allDaySlot && (jsxs(Fragment, { children: [jsxs("div", { role: 'row', "aria-rowindex": firstBodyRowIndex, className: classNames.flexRow, style: { zIndex: 1 }, children: [jsx(TimeGridAllDayHeader, { width: axisWidth, innerWidthRef: this.handleAllDayLabelInnerWidth, isNarrow: cellIsNarrow }), jsx("div", { className: generateClassName(options.slotHeaderDividerClass, {
                                                inTableHeader: false,
                                                options: { dayMinWidth: options.dayMinWidth },
                                            ...
                                            className: joinClassNames(classNames.flexRow, classNames.liquidX), ref: this.allDayScrollerRef, children: [jsx("div", { className: classNames.flexRow, style: { width: canvasWidth }, children: jsx(TimeGridAllDayLane, { dateProfile: props.dateProfile, todayRange: props.todayRange, cells: props.cells, showDayNumbers: false, forPrint: forPrint, isHitComboAllowed: props.isHitComboAllowed, className: joinClassNames(classNames.borderNone, classNames.liquidX), cellIsNarrow: cellIsNarrow, cellIsMicro: cellIsMicro, 
                                                        ...
                                                        // dimensions
                                                        colWidth: colWidth }) }), Boolean(endScrollbarWidth) && (jsx("div", { className: joinClassNames(generateClassName(options.fillerClass, { inTableHeader: false }), classNames.borderOnlyS), style: { minWidth: endScrollbarWidth } }))] })] }), jsx("div", { className: joinClassNames(options.allDayDividerClass), style: { zIndex: 2 } })] })), jsxs("div", { role: 'row', "aria-rowindex": firstBodyRowIndex + (options.allDaySlot ? 1 : 0), className: joinClassNames(classNames.flexRow, classNames.rel, // for Ruler.fillStart
                            verticalScrolling && classNames.liquid), style: {
                                zIndex: 0,
                            }, children: [jsx(Scroller, { vertical: verticalScrolling, hideScrollbars: true, className: joinClassNames(classNames.flexCol, classNames.contentBox), style: {
                                        width: axisWidth,
                                    ...
                                    className: joinClassNames(classNames.flexCol, classNames.liquid), children: [jsx(Scroller, { vertical: verticalScrolling, horizontal: true, hideScrollbars: footerScrollbarSticky || // also means height:auto, so won't need vertical scrollbars anyway
                                            ...
                                            verticalScrolling && classNames.liquid), ref: this.mainScrollerRef, clientWidthRef: this.handleClientWidth, clientHeightRef: this.handleClientHeight, children: jsxs("div", { className: joinClassNames(classNames.flexCol, classNames.grow, classNames.rel), style: {
                                                    width: canvasWidth,
                                                    height: forcedBodyHeight,
                                                }, children: [jsx(TimeGridCols, { dateProfile: props.dateProfile, nowDate: props.nowDate, todayRange: props.todayRange, cells: props.cells, slatCnt: slatCnt, forPrint: forPrint, isHitComboAllowed: props.isHitComboAllowed, className: simplePrint ? '' : classNames.fill, 
                                                        // content
...
class TimeGridLayoutNormal extends BaseComponent {
    ...
    render() {
        ...
        return (jsxs(Fragment, { children: [options.dayHeaders && (jsxs("div", { role: 'rowgroup', className: joinClassNames(generateClassName(options.tableHeaderClass, {
                    ...
                    classNames.flexCol, tableHeaderSticky && classNames.tableHeaderSticky), style: {
                        zIndex: 1,
                    }, children: [props.headerTiers.map((rowConfig, tierNum) => (jsxs("div", { role: 'row', className: classNames.flexRow, children: [jsx("div", { className: joinClassNames(options.dayHeaderRowClass, classNames.flexRow, tierNum < props.headerTiers.length - 1
                                        ? classNames.borderOnlyB
                                        : classNames.borderNone), children: (options.weekNumbers && rowConfig.isDateRow) ? (jsx(TimeGridWeekNumber, { dateProfile: props.dateProfile, innerWidthRef: this.handleWeekNumberInnerWidth, innerHeightRef: headerLabelInnerWidthRefMap.createRef(tierNum), width: axisWidth, isLiquid: false, isNarrow: cellIsNarrow })) : (jsx(TimeGridAxisEmpty, { width: axisWidth, isLiquid: false })) }), jsx("div", { className: generateClassName(options.slotHeaderDividerClass, {
                                        inTableHeader: true,
                                        options: { dayMinWidth: options.dayMinWidth },
                                    }) }), jsx(DayGridHeaderRow, { ...rowConfig, className: classNames.liquid, borderBottom: tierNum < props.headerTiers.length - 1, viewportWidth: clientWidth, cellIsNarrow: cellIsNarrow, cellIsMicro: cellIsMicro, rowLevel: props.headerTiers.length - tierNum - 1 }), Boolean(endScrollbarWidth) && (jsx("div", { className: joinClassNames(generateClassName(options.fillerClass, { inTableHeader: true }), classNames.borderOnlyS), style: { minWidth: endScrollbarWidth } }))] }, tierNum))), jsx("div", { className: generateClassName(options.dayHeaderDividerClass, {
                                isSticky: tableHeaderSticky,
                                multiMonthColumns: 0,
                                options: { allDaySlot: Boolean(options.allDaySlot) },
                            }) })] })), jsxs("div", { role: 'rowgroup', className: joinClassNames(generateClassName(options.tableBodyClass, {
                        ...
                        zIndex: 0,
                    }, children: [options.allDaySlot && (jsxs(Fragment, { children: [jsxs("div", { role: 'row', className: classNames.flexRow, style: { zIndex: 1 }, children: [jsx(TimeGridAllDayHeader, { width: axisWidth, innerWidthRef: this.handleAllDayLabelInnerWidth, isNarrow: cellIsNarrow }), jsx("div", { className: generateClassName(options.slotHeaderDividerClass, {
                                                inTableHeader: false,
                                                options: { dayMinWidth: options.dayMinWidth },
                                            }) }), jsx(TimeGridAllDayLane, { dateProfile: props.dateProfile, todayRange: props.todayRange, cells: props.cells, showDayNumbers: false, forPrint: forPrint, isHitComboAllowed: props.isHitComboAllowed, className: joinClassNames(classNames.liquidX, classNames.borderNone), cellIsNarrow: cellIsNarrow, cellIsMicro: cellIsMicro, 
                                            // content
                                            fgEventSegs: props.fgEventSegs, bgEventSegs: props.bgEventSegs, businessHourSegs: props.businessHourSegs, dateSelectionSegs: props.dateSelectionSegs, eventDrag: props.eventDrag, eventResize: props.eventResize, eventSelection: props.eventSelection, dayMaxEvents: props.dayMaxEvents, dayMaxEventRows: props.dayMaxEventRows }), Boolean(endScrollbarWidth) && (jsx("div", { className: joinClassNames(generateClassName(options.fillerClass, { inTableHeader: false }), classNames.borderOnlyS), style: { minWidth: endScrollbarWidth } }))] }), jsx("div", { className: joinClassNames(options.allDayDividerClass), style: { zIndex: 2 } })] })), jsx(Scroller, { vertical: verticalScrolling, className: joinClassNames(classNames.flexCol, classNames.rel, // for Ruler.fillStart
                            verticalScrolling && classNames.liquid), style: {
                                zIndex: 0,
                            }, ref: props.timeScrollerRef, clientWidthRef: this.handleClientWidth, clientHeightRef: this.handleClientHeight, children: jsxs("div", { className: joinClassNames(classNames.flexCol, classNames.grow, classNames.rel), style: {
                                    ...
                                    height: forcedBodyHeight,
                                                    ...
                                                    inTableHeader: false,
                                                    options: { dayMinWidth: options.dayMinWidth },
                                                }) }), jsx(TimeGridCols, { dateProfile: props.dateProfile, nowDate: props.nowDate, todayRange: props.todayRange, cells: props.cells, slatCnt: slatCnt, forPrint: forPrint, isHitComboAllowed: props.isHitComboAllowed, className: classNames.liquid, 
                                                // content
                                                fgEventSegsByCol: props.fgEventSegsByCol, bgEventSegsByCol: props.bgEventSegsByCol, businessHourSegsByCol: props.businessHourSegsByCol, nowIndicatorSegsByCol: props.nowIndicatorSegsByCol, dateSelectionSegsByCol: props.dateSelectionSegsByCol, eventDragByCol: props.eventDragByCol, eventResizeByCol: props.eventResizeByCol, eventSelection: props.eventSelection, 
                                                // dimensions
...
export { AllDaySplitter as A, DayTimeColsSlicer as D, NowIndicatorHeaderContainer as N, Splitter as S, TimeGridLayout as T, buildDayRanges as a, buildTimeColsModel as b, NowIndicatorLineContainer as c, NowIndicatorDot as d, organizeSegsByCol as o, splitInteractionByCol as s };
